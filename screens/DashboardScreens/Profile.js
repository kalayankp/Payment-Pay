  ...
  return (
    ...
    <SafeAreaView >
      ...
      <View style={{ marginTop: 50 }}>
        ...
        <TouchableOpacity onPress={() => { navigation.navigate('ProfileInfo') }} style={{ borderBottomWidth: 1, marginTop: 5,  }}>
          {/* <View style={{ flexDirection: 'row', marginBottom: 12, marginTop: 12 }}> */}
          <View style={{ flexDirection: 'row',justifyContent:'space-between',  marginBottom: 16,marginLeft:12 }}>
            <View style={{ width:'15%'}}>
            <Image style={{ width: 30, height: 30, }} source={require('../../assests/icons/images/preferences.png')} />
            </View>
      
            <View style={{width:'70%',}}>
              <Text style={{ marginTop: 0,textAlign:'center', fontWeight: '400', fontSize: 20, color: 'black', width: 170 }}>Profile Info</Text>
            </View>
            <View style={{width:'15%'}} >
        ...
        <TouchableOpacity onPress={() => { navigation.navigate('EditProfile') }} style={{ borderBottomWidth: 1, marginTop: 25,  }}>
          {/* <View style={{ flexDirection: 'row', marginBottom: 12, marginTop: 12 }}> */}
          <View style={{ flexDirection: 'row',justifyContent:'space-between',  marginBottom: 16,marginLeft:12 }}>
            <View style={{ width:'15%'}}>
            ...
            <View style={{width:'70%',}}>
              <Text style={{ marginTop: 0,textAlign:'center', fontWeight: '400', fontSize: 20, color: 'black', width: 170 }}>Edit Profile</Text>
            </View>
            <View style={{width:'15%'}} >
              <Image style={{ width: 30, height: 30, justifyContent: 'flex-end', alignItems: 'flex-end', }} source={require('../../assests/icons/arrow.png')} />
            </View>
        ...
        <TouchableOpacity onPress={() => { navigation.navigate('') }} style={{ borderBottomWidth: 1, marginTop: 25,  }}>
          {/* <View style={{ flexDirection: 'row', marginBottom: 12, marginTop: 12 }}> */}
          <View style={{ flexDirection: 'row',justifyContent:'space-between',  marginBottom: 16,marginLeft:12 }}>
            <View style={{ width:'15%'}}>
            ...
            <View style={{width:'70%',}}>
              <Text style={{ marginTop: 0,textAlign:'center', fontWeight: '400', fontSize: 20, color: 'black', width: 170 }}>About Us  </Text>
            </View>
            <View style={{width:'15%'}} >
        ...
        <TouchableOpacity onPress={() => LogOut()} style={{ borderBottomWidth: 1, marginTop: 25, marginBottom:"52%" }}> 
          {/* <View style={{ flexDirection: 'row', marginBottom: 12, marginTop: 12 }}> */}
          <View style={{ flexDirection: 'row',justifyContent:'space-between',  marginBottom: 16,marginLeft:12 }}>
            <View style={{ width:'15%'}}>
              <Image style={{ width: 31, height: 30, }} source={require('../../assests/images/switch.png')} />
            </View>
            <View style={{width:'70%',}}>
              <Text style={{ marginTop: 0,textAlign:'center', fontWeight: '400', fontSize: 20, color: 'black', width: 170,marginBottom:'50%' }}>Logout    </Text>
            </View>
            <View style={{width:'15%'}} >
              <Image style={{ width: 30, height: 30, justifyContent: 'flex-end', alignItems: 'flex-end', }} source={require('../../assests/icons/arrow.png')} />
            </View>
