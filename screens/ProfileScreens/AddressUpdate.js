    ...
    <View>
      <View style={{ backgroundColor: '#132fba', borderBottomLeftRadius: 10, borderBottomRightRadius: 10, marginLeft: 0.5, marginRight: 0.5 }}>
        <View style={{ flexDirection: 'row', padding: 15, }}>
          ...
          <Text style={{ fontSize: 20, fontWeight: '400', justifyContent: 'center', textAlign: 'center', color: 'white', marginLeft: '29%' }}>Update Address</ Text>
        </View>
      </View>
        
        <View style={{ marginTop: "10%", elevation: 3, margin: 11 }}>
        ...
        <View style={{ flexDirection: 'row', margin: 18, }}>
          <TextInput placeholder="PIN *" placeholderTextColor='grey'  keyboardType="numeric" onChangeText={(value) => setPin(value)} style={{ borderBottomWidth: 1, width: "35%", textAlign: 'center', marginLeft: 10, fontSize: 18 }} />
