...
const Gasoperator = ({ navigation, route }) => {
   ...
   <SafeAreaView> 
      ...
      <View style={{ backgroundColor: '#132fba', borderBottomLeftRadius: 10, borderBottomRightRadius: 10, marginLeft: 0.5, marginRight: 0.5 }}>
        <View style={{ flexDirection: 'row', padding: 15, }}>
          ...
          <Text style={{ fontSize: 20, fontWeight: '400', textAlign: 'center', color: 'white', marginLeft:'20%'}}>SELECT Gas OPERATOR</ Text>
          </View>
          </View>
...
<TouchableOpacity
  ...
  <Text style={{ fontSize: 22, color: 'white',padding: 2,textAlign:'center', }}>PROCEED</Text>
