...
const CreditCardOperator = ({ navigation, route }) => {
  ...
  const getData = () => {
    fetch(`${REACT_APP_BASE_Bill_URL}/getCreditCardBillers`)
      .then(res => res.json())
      .then(data =>
        //console.log(data),
  ...
  return (
    <View>
      ...
      <View style={{ width: '100%', height: '10%', backgroundColor: '#E8E8E8' }}>
        <Text style={{ fontSize: 24, fontWeight: 'bold', color: "black", padding: 5,paddingLeft:10 }}>Credit Card Bill </Text>
      </View>
         {/* search bar */}
      <View>
...
export default CreditCardOperator