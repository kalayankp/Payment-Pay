...
const PaymentSucess = ({ navigation, route }) => {
    const { cust_name, refId, billerTotalAmount, billerReferenceNumber, payTime, bbpsNo, time,txnId } = route.params;


    //console.log('=imei============>', JSON.stringify(billerReferenceNumber))
    console.log('=======ip is======>', JSON.stringify(cust_name))
