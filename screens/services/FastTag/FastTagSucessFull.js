    ...
    return (
      <View style={{ flex: 1, height: '100%' }}>
          ...
          <LinearGradient
              ...
              style={{ borderWidth: 1, borderRadius: 22, borderBottomColor: 'blue', borderBottomWidth: 5, padding: '5%', marginTop: '10%', margin: 10, borderWidth: 1, borderColor: 'white' }}>
              <View style={{}}>
                  <View style={{ flexDirection: "row" }}>
                      <View>
                          <Image source={require('../../../../assests/icons/ringpeWhiteIcons.png')} style={{ width: 80, height: 70, marginTop:5, marginLeft: -10 }} />
                      </View>
                      <Text style={{ fontSize: 28, fontWeight: '600',marginLeft:'15%',color: 'white', marginTop: '10%' }}> {cust_name}</Text>
                  </View>
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: '0%', marginLeft: '10%' }}>
                      ...
                      <Text style={{ fontSize: 40, fontWeight: '600', color: 'white', marginLeft: 10 }}>{billerTotalAmount}</Text>
                  </View> 

                  <Text style={{ fontSize: 18, fontWeight: '600', color: 'skyblue', marginLeft: "33%", padding: '1%' }}>{time}</Text>
                  <View style={{flexDirection:'row',marginTop: '4%'}}>
                  <Text style={{ fontSize: 13, fontWeight: '400', color: 'white', marginLeft: "-4%", padding: '4%',  }}>Order ID:</Text>
                  <Text style={{ fontSize: 13, fontWeight: '400', color: 'white',marginTop: '4%',paddingRight:-3,margin:-11}}>{billerReferenceNumber}</Text>
                  </View>
          ...
          <View style={{ flex: 2, width: "100%", flexDirection: 'row', borderWidth: 1, borderTopWidth: 2, borderBottomWidth: 2, elevation: 1, padding: 14, borderBottomColor: 'white', borderTopColor: 'white', backgroundColor: "white", position: 'absolute', bottom: 1, justifyContent: 'center' }}>
              ...
              <Image source={require('../../../../assests/icons/bbps.png')} style={{ width: 35, height: 55, marginLeft: '2%' }} />
...
export default FastTagSucessFull
