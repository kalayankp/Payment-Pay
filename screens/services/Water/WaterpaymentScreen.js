...
const WaterpaymentScreen = ({ navigation, route }) => {
    const { cust_name, refId, billerTotalAmount, billerReferenceNumber, payTime, bbpsNo, time } = route.params;
    ...
    return (
        <View style={{ flex: 1, height: '100%' }}>
            ...
            <LinearGradient
                ...
                style={{ borderWidth: 1, borderRadius: 22, borderBottomColor: 'blue', borderBottomWidth: 5, padding: 20, marginTop: '10%', margin: 10, borderWidth: 1, borderColor: 'white' }}>
                <View style={{}}>
                    <View style={{ flexDirection: "row" }}>
                        <View>
                            <Image source={require('../../../assests/icons/ringpeIcon.png')} style={{ width: 112, height: 122, marginTop: -20, marginLeft: -20 }} />
                        </View>
                        <Text style={{ fontSize: 28, fontWeight: '600', marginLeft: 18, color: 'white', marginTop: '10%' }}> {cust_name}</Text>
                    </View>
...
export default WaterpaymentScreen
