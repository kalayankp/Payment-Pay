...
const ElectricityBill = ({ navigation, route }) => {
  ...
  const getData = () => {
    fetch(`${REACT_APP_BASE_Bill_URL}/getElectricityBillers`)
      .then(res => res.json())
      .then(data =>
        //console.log(data),
    ...
    <View>
      <View style={{ backgroundColor:'#132fba', borderBottomLeftRadius: 10, borderBottomRightRadius: 10, marginLeft: 0.5, marginRight: 0.5 }}>
        <View style={{ flexDirection:'row', padding: 15, }}>
          ...
          <Text style={{ fontSize: 20, fontWeight:'400', justifyContent: 'center', textAlign: 'center', color: 'white', marginLeft: '30%' }}>Electricity</Text>
        </View>
      </View>
