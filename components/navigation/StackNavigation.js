...
import WaterpaymentScreen from '../../screens/services/Water/WaterpaymentScreen';
...
import FastTagBillFetch from '../../screens/services/FastTag/FastTagBillFetch';
...
import WaterBillForm from '../../screens/services/Water/WaterBillForm';
import WaterBillOperator from '../../screens/services/Water/WaterBillOperator'; 
import WaterBillFetch from '../../screens/services/Water/WaterBillFetch';
import UserBillBroadBand from '../../screens/services/BroadBand/UserBillBroadBand';
import CreditCardOperator from '../../screens/services/CreditCard/CreditCardOperator';
import CreditCardForm from '../../screens/services/CreditCard/CreditCardForm';
import CreditCardBillFetch from '../../screens/services/CreditCard/CreditCardBillFetch';
import Gasoperator from '../../screens/services/GasBill/Gasoperator';
//import MobileScreen from '../../screens/services/Prepaid/MobileScreen';
import BroadBandOperator from '../../screens/services/BroadBand/BroadBandOperator';
...
const StackNavigation = () => {
  ...
  return (
    <Stack.Navigator initialRouteName="WelcomeScreen">
      ...
      <Stack.Screen name="HeaderNav" component={HeaderNav} options={{ headerShown: false, }} />
      ...
      <Stack.Screen name="FastTagBillFetch" component={FastTagBillFetch} options={{ headerShown: false, }} />
      
      <Stack.Screen name="WaterBillForm" component={WaterBillForm} options={{ headerShown: false, }} />
      <Stack.Screen name="WaterBillOperator" component={WaterBillOperator} options={{ headerShown: false, }} />
      <Stack.Screen name="WaterBillFetch" component={WaterBillFetch} options={{ headerShown: false, }} />
      <Stack.Screen name="WaterpaymentScreen" component={WaterpaymentScreen} options={{ headerShown: false, }} />
      <Stack.Screen name="BroadBandOperator" component={BroadBandOperator} options={{ headerShown: false, }} />
      <Stack.Screen name="UserBillBroadBand" component={UserBillBroadBand} options={{ headerShown: false, }} />
      <Stack.Screen name="CreditCardOperator" component={CreditCardOperator} options={{ headerShown: false, }} />
      <Stack.Screen name="CreditCardForm" component={CreditCardForm} options={{ headerShown: false, }} />
      <Stack.Screen name="CreditCardBillFetch" component={CreditCardBillFetch} options={{ headerShown: false, }} />
    
      <Stack.Screen name="Gasoperator" component={Gasoperator} options={{ headerShown: false, }} />
      ...
      <Stack.Screen name="ExistAccount" component={ExistingBackAccount} options={{ animation: "slide_from_right", headerShown: false, }} />
      <Stack.Screen name="UpdateBankAccount" component={UpdateBankAccount} options={{ animation: "slide_from_bottom", headerShown: false, }} />
      ...
      <Stack.Screen name="ChangePassword" component={ChangePassword} options={{ animation: "slide_from_right", headerShown: false}} />
      <Stack.Screen name="LinkBankAcc" component={LinkBankAcc} options={{ headerShown: false, }} />
      <Stack.Screen name="WalletClosure" component={WalletClosure} />
      <Stack.Screen name="IncomeVerification" component={IncomeVerification} options={{ animation: "slide_from_right", headerShown:false }} />
      <Stack.Screen name="TpinScreen" component={TpinScreen} options={{ animation: "slide_from_right", title: 'SET TPIN' }} />
      <Stack.Screen name="Settings" component={Settings} />
      <Stack.Screen name="AddressUpdate" component={AddressUpdate} options={{ animation: "slide_from_right", title: 'ADDRESS UPDATES', headerShown: false }} />
